...
cont50 = cont20 = cont10 = cont5 = cont1 = 0

while (somaValor + 50) <= valorSaque:
    somaValor += 50
    cont50 += 1

while (somaValor + 20) <= valorSaque:
    somaValor += 20
    cont20 += 1

while (somaValor + 10) <= valorSaque:
    somaValor += 10
    cont10 += 1

while (somaValor + 5) <= valorSaque:
    somaValor += 5
    cont5 += 1

while (somaValor + 1) <= valorSaque:
    somaValor += 1
    cont1 += 1

print(f'\n\033[31m{"CONCLUSÃO":-^20}', end='\033[m\n')
print(f"""
